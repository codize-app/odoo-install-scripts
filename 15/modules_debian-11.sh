...
sudo mkdir sources
cd sources
sudo git clone https://github.com/codize-app/odoo-argentina -b 15.0
sudo git clone https://github.com/OCA/reporting-engine -b 15.0
sudo git clone https://github.com/OCA/web -b 15.0
