...
echo ADDONS_PATH:
sudo sed -i 's/\/opt\/odoo\/addons/\/opt\/odoo\/addons, \/opt\/odoo\/sources, \/opt\/odoo\/sources\/odoo-argentina, \/opt\/odoo\/sources\/odoo-argentina-withholding, \/opt\/odoo\/sources\/account-reconcile, \/opt\/odoo\/sources\/CybroAddons, \/opt\/odoo\/sources\/reporting-engine, \/opt\/odoo\/sources\/om_account_accountant/g' /etc/odoo.conf
